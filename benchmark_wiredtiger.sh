nohup dstat -tcm --output /datainssd/ycsbtest/cpumemory/wiredtiger_snappy_6_movies_uniform_workloadc_mem3g_new_1_thread_1_96_1 2 > nohup.out &
#
...
bin/ycsb run mongodb -s -P workloads/workloadc -threads 1 > /datainssd/ycsbtest/benchmarktest/run_wiredtiger_snappy_6_movies_uniform_workloadc_mem3g_new_1_thread_1_96_1
